...
Note: The variable name could be either `GH_TOKEN` or anything else. But the variable names must match
in the workflow (`${{ secrets.GH_TOKEN }}`)and the repository secret section.