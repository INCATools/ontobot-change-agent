...
b. **OWL Resource**: The template for the workflow is provided (based on resource format) by `this YAML file <https://github.com/hrshdhgd/ontobot-change-agent/blob/main/.github/workflows/new-pr-java.yml>`_.
Just uncomment the code and change the following:
